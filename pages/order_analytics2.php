...
echo "<h1 align=center style='margin-top:80px'>Monthly Development of Orders in". $year. "</h1>
...
<br>
<br>
<button type="submit"  class="btn" name="table1" style="margin-left:27.5%">Table</button>
